...
add_template = "curl -s -XPUT 'http://localhost:9200/cloudify_storage/{type}/{id}/_create' -d \'{source}\'"
    ...
    for dep in deployments:
        ...
        with open(os.devnull, "w") as FNULL:
            ...
            for node in nodes["hits"]["hits"]:
                ...
                add_command = add_template.format(type=str(node["_type"]), id = str(node["_id"]), source=source)
